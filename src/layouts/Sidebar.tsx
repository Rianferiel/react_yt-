import { ChevronDown, ChevronUp, Clapperboard, Clock, Home, Library, PlaySquare, Repeat, History } from "lucide-react"
...
export function Sidebar(){
  return (
    <>
      <aside className="sticy top-0 overflow-y-auto scrollbar-hidden pb-4 flex flex-col ml-1 lg:hidden">
