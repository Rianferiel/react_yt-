  ...
  return (
    <div className="flex gap-10 lg:gap-20 justify-between pt-2 mb-6 mx-4">
      ...
      <form className={`gap-4 flex-grow justify-center ${showFullWidthSearch ? "flex" : "hidden md:flex"}`}>
        {showFullWidthSearch && (
          <Button onClick={() => setShowFullWidthSearch(false)} type="button" size="icon" variant="ghost" className="md:hidden">
            <ArrowLeft/>
          </Button>
        )}
        <div className="flex flex-grow max-w-[600px]">
          ...
          <Button type="button" className="py-2 px-4 rounded-r-full border border-secondary-border border-l-0">
            <Search/>
          </Button>
        </div>
      ...
      <div className={`flex-shrink-0 md:gap-2 ${showFullWidthSearch ? "hidden" : "flex"}`}>
        <Button onClick={() => setShowFullWidthSearch(true)} type="button" size="icon" variant="ghost" className="md:hidden">
          <Search/>
        </Button>
